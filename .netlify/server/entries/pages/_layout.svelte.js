...
var define_PKG_default = { name: "supabase-auth", version: "1.0.3", private: true, scripts: { dev: "vite dev --open --port 5174", build: "vite build", preview: "vite preview", check: "svelte-kit sync && svelte-check --tsconfig ./tsconfig.json", "check:watch": "svelte-kit sync && svelte-check --tsconfig ./tsconfig.json --watch", lint: "prettier --check . && eslint .", format: "prettier --write ." }, devDependencies: { "@rollup/rollup-darwin-arm64": "^4.18.1", "@sveltejs/adapter-auto": "^3.0.0", "@sveltejs/adapter-netlify": "^4.3.1", "@sveltejs/kit": "^2.0.0", "@sveltejs/vite-plugin-svelte": "^3.1.1", "@types/eslint": "8.56.0", "@typescript-eslint/eslint-plugin": "^6.0.0", "@typescript-eslint/parser": "^6.0.0", "@zerodevx/svelte-toast": "^0.9.5", autoprefixer: "^10.4.16", eslint: "^8.56.0", "eslint-config-prettier": "^9.1.0", "eslint-plugin-svelte": "^2.35.1", postcss: "^8.4.32", "postcss-load-config": "^5.0.2", prettier: "^3.1.1", "prettier-plugin-svelte": "^3.1.2", "prettier-plugin-tailwindcss": "^0.5.9", svelte: "^4.2.7", "svelte-check": "^3.6.0", tailwindcss: "^3.3.6", tslib: "^2.4.1", typescript: "^5.0.0", vite: "5.3.3" }, type: "module", dependencies: { "@rollup/wasm-node": "^4.18.1", "@supabase/ssr": "^0.1.0", "@supabase/supabase-js": "^2.39.3", daisyui: "^4.6.0", "lucide-svelte": "^0.407.0", "save-dev": "^0.0.1-security", "svelte-toast": "^1.0.0" } };
